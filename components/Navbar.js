  ...
  return (
    ...
    <div
      className={`bg-gray-950 flex ${
        session ? "flex-col" : "flex-row"
      } md:flex-row justify-between items-center px-5 py-2`}
    >
      <Link href={"/"} className="z-50 logo font-bold text-lg inline-block">
        FundMySamosa!
      </Link>
      <div className="flex gap-2 items-center">
        {session && (
          <div className="relative group z-50">
            ...
            <div className="absolute hidden group-hover:flex flex-col min-w-[130px] bg-white text-gray-800 rounded-md shadow-lg border border-gray-200 transition-all duration-500 ease-in-out opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-1 scale-95 group-hover:scale-100 origin-top transform z-10">
              <Link href={"/dashboard"}>
